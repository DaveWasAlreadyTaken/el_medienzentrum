...
export default {
  ...
  beforeUnmount() {
    ...
    console.log("Element",document.getElementById('-holder2'))
    if(document.getElementById(this.id+'-holder2'))document.getElementById(this.id+'-holder2').remove();
    if(this.viewer) this.viewer.destroy();
  },
  computed:{
    sortedImages(){
